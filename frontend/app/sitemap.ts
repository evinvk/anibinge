...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  // Anime topic-cluster hubs: /anime/{id}
  ...
  // Episode-level landing pages: /watch/{slug}?ep=N
