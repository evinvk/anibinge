...
export function SearchModal({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  return (
    <div
      className="fixed inset-0 z-[100] flex items-start justify-center bg-void/80 backdrop-blur-sm pt-20 px-4 animate-[fadeIn_0.15s_ease-out]"
      onClick={onClose}
    >
      <div
        onClick={(e) => e.stopPropagation()}
        className="glass-card w-full max-w-xl overflow-hidden animate-[slideUp_0.15s_ease-out]"
      >
