...
from app.routers import admin, anime, auth, comments, news, notifications, schedule, search, seasonal, selfhosted, streaming, watchlist
...
app.include_router(selfhosted.router)
